                        ...
                        <table class="min-w-full ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-3 py-3 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Room</th>
                                ...
                                <?php
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "<td class='px-3 py-4 whitespace-nowrap'>" . $row["building"]  ."</td>";
    ...
    <div id="room-form" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        <div class="bg-white py-4 px-6 rounded-md">
            ...
            <form method="POST" action="create_room.php">
                ...
                <div class="mt-6">
                    <button type="submit" onclick="SubmitRoomForm()" class="w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
                        Submit
                    </button>
                </div>
            </form>
