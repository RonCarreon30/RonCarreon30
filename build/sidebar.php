...
<div id="sidebar" class="flex flex-col items-center w-16 h-full overflow-hidden text-blue-200 bg-plv-blue rounded-r-lg">
    ...
    switch ($userRole) {
        ...
        case "Admin":
            ...
            <!-- Admin Sidebar Links -->
            <div class="flex flex-col items-center mt-3 border-t border-gray-700">
                <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-persian-blue" href="adminDashboard.php" title="Dashboard">
        ...
        case "Dept. Head":
            ...
            <div class="flex flex-col items-center mt-3 border-t border-gray-700">
                <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-persian-blue" href="deptHeadDashboard.php" title="Dashboard">
                    <i class="fa-solid fa-home"></i>
                </a>
        ...
        case "Student Rep":
            ...
            <div class="flex flex-col items-center mt-3 border-t border-gray-700">
                <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-persian-blue" href="studentRepDashboard.php" title="Home">
                    <i class="fa-solid fa-home"></i>
                </a>
            </div>
            <?php
